...
// AzureVMSchedulerReconciler reconciles a AzureVMScheduler object
type AzureVMSchedulerReconciler struct {
	client.Client
...
// the AzureVMScheduler object against the actual cluster state, and then
...
func (r *AzureVMSchedulerReconciler) SetupWithManager(mgr ctrl.Manager) error {
	return ctrl.NewControllerManagedBy(mgr).
		For(&azurev1.AzureVMScheduler{}).
		Complete(r)
}
